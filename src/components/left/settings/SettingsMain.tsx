      ...
      <div className={styles.menuSection}>
        <Island>
          <ListItem
            ...
            multiline
            narrow
            onClick={() => openSettingsScreen({ screen: SettingsScreens.Bygram })}
          >
            <span className="title">{lang('BygramSettings')}</span>
            <span className="subtitle">{lang('BygramSettingsDesc')}</span>
          </ListItem>
