...
"ChatBackgroundColorThemes" = "Colors, Gradients & Patterns";
"Theme" = "Theme";
...
"BackgroundPatternIntensity" = "Pattern Intensity";
...
"AutoDeleteSettingsInfo" = "Automatically delete messages for everyone after a period of time in all new chats you start.";
"SetAutoDeleteTimer" = "Set Auto-Delete";
"SetCustomTime" = "Set Custom Time";
"AutoDeletePopupTitle" = "Auto-Delete";
"AutoDeletePopupDescription" = "Automatically delete messages sent in this chat after a certain period of time.";
"AutoDeleteNever" = "Never";
"AutoDeleteConfirm" = "Confirm";
"AutoDeleteSetInfo" = "Messages in this chat are automatically deleted {time} after they are sent.";
"AutoDeleteIn" = "Auto-deletes in {time}";
"AutoDeleteGlobalActionFromYou" = "You set a self-destruct timer for all chats.\\nAll new messages in this chat will be automatically deleted {time} after they were sent.";
"AutoDeleteGlobalAction" = "{from} uses a self-destruct timer for all chats.\\nAll new messages in this chat will be automatically deleted {time} after they are sent.";
"ActionTTLYouChanged" = "You set messages to auto-delete in {time}";
"ActionTTLChanged" = "{from} set messages to auto-delete in {time}";
"ActionTTLYouDisabled" = "You disabled the auto-delete timer";
"ActionTTLDisabled" = "{from} disabled the auto-delete timer";
"ActionTTLChannelChanged" = "Messages in this channel will be automatically deleted after {time}";
...
"EphemeralOnlyVisible" = "Only visible to you";
"EphemeralOnlyVisibleToBot" = "Only visible to {bot}";
"EphemeralContextMenuNotice" = "Only you see this message. It will disappear after you log in again.";
"EphemeralReplyUnavailable" = "Message is no longer available";
...
"GuardApproveNewPublicGroupMembersInfo" = "An admin must approve users who want to send messages in the group.";
...
"StickerSearchResult" = "Search Result";
"StickerSearchGlobalResult" = "Global Search Result";
"NoStickersFound" = "No stickers found";
"TrendingStickers" = "Trending Stickers";
"TrendingPremiumStickers" = "Trending Premium Stickers";
"AccDescrCloseTrendingStickers" = "Close trending stickers";
...
"PremiumUnlockEmoji" = "Subscribe to Telegram Premium to unlock premium emoji.";
"PremiumUnlockStickers" = "Subscribe to Telegram Premium to unlock premium stickers.";
"StickerPackRemoveEmojiCount_one" = "Remove {count} emoji";
"StickerPackRemoveEmojiCount_other" = "Remove {count} emoji";
"StickerPackAddEmojiCount_one" = "Add {count} emoji";
"StickerPackAddEmojiCount_other" = "Add {count} emoji";
...
"AudioAddToProfile" = "Add to Profile";
"AudioRemoveFromProfile" = "Remove from Profile";
"AudioSaveToMyProfileSaved" = "Audio added to your profile.";
"AudioSaveToMyProfileUnsaved" = "Audio removed from your profile.";
...
"RichEditorFormula" = "Equation";
"RichEditorFormulaPrompt" = "Enter equation...";
"RichEditorFormulaToBlock" = "Convert to block equation";
"RichEditorFormulaToInline" = "Convert to inline equation";
...
"JoinRequestAcceptAll" = "Accept all";
"JoinRequestDismissAll" = "Dismiss all";
...
"ProfileTabPlaylist" = "Playlist";
"ProfilePlaylistEmpty" = "No music added yet";
...
"ActionAddedToCommunity" = "{from} added this chat to {community}";
"ActionRemovedFromCommunity" = "{from} removed this chat from the community";
"CommunityOpenPanel" = "Show community chats";
"CommunityShowAsOneChat" = "Show as One Chat";
"CommunityShowAsOneChatHint" = "Group all community chats into one item in the chat list.";
"CommunityChatsYouAreIn" = "Chats you are in";
"CommunityChatsYouCanView" = "Chats you can view";
"CommunityChatsYouCanJoin" = "Chats you can request to join";
"CommunitySearchChats" = "Search chats";
"CommunityNoChatsFound" = "No chats found";
"CommunityJoinChatConfirm" = "Do you want to join this chat?";
"CommunityChatNotAccessible" = "This chat is not accessible.";
"CommunityChatsCount_one" = "{count} chat";
"CommunityChatsCount_other" = "{count} chats";
"CommunityWithChats_one" = "Community with {count} chat";
"CommunityWithChats_other" = "Community with {count} chats";
...
"PremiumPreviewRichFormatting" = "Rich Formatting";
"PremiumPreviewRichFormattingDescription" = "Format your messages with headings, lists, quotes and other rich blocks.";
"NativeDownloadFailed" = "Failed to save file to the Downloads folder";
"DescriptionAboutGram" = "Use Grams to buy gifts and suggest posts to channels.";
...
"PersonalChannelAddHint" = "Add your channel";
...
"FwdMessagesToSaved_one" = "Message forwarded to **Saved Messages**";
"FwdMessagesToSaved_other" = "Messages forwarded to **Saved Messages**";
...
"AutoDeleteBadgeSeconds" = "s";
"AutoDeleteBadgeMinutes" = "m";
"AutoDeleteBadgeHours" = "h";
"AutoDeleteBadgeDays" = "d";
"AutoDeleteBadgeWeeks" = "w";
"AutoDeleteBadgeMonths" = "m";
"AutoDeleteBadgeYears" = "y";
"SettingsAccount" = "Account";
"SettingsAccountDesc" = "Username, Bio, Birthday";
"SettingsGeneralDesc" = "Wallpaper, Theme, Keyboard";
"SettingsNotificationsDesc" = "Sounds, Calls, Badges";
"SettingsPrivacyDesc" = "Last Seen, Password, Blocked Users";
"SettingsDataDesc" = "Media Download, Cache";
"SettingsFoldersDesc" = "Sort chats into folders";
"SettingsPerformanceDesc" = "Animations, Transitions, Autoplay";
"SettingsStickersDesc" = "Stickers, Emoji, Reactions";
"SettingsLanguageDesc" = "{language}, Translate Messages";
"SettingsSessionsDesc" = "Sessions, Automatically terminate";
"BygramSettings" = "bygram";
"BygramSettingsDesc" = "Локальный архив и защита сообщений";
"BygramSendAsRoundVideo" = "Отправить как кружок";
"BygramRoundVideoProcessing" = "Подготовка кружка…";
"BygramRoundVideoTooLong" = "Для кружка выберите видео не длиннее 1 минуты";
"BygramRoundVideoFailed" = "Не удалось подготовить кружок";
"BygramArchiveTitle" = "Архив сообщений";
"BygramLocalArchive" = "Локальный архив сообщений";
"BygramLocalArchiveDesc" = "Сохранять текст и метаданные полученных сообщений в IndexedDB";
"BygramAntiDelete" = "Антиудаление";
"BygramAntiDeleteDesc" = "Сохранять сообщения, которые позднее были удалены в Telegram";
"BygramEditHistory" = "История изменений";
"BygramEditHistoryDesc" = "Сохранять предыдущие версии изменённых сообщений";
"BygramIosNotice" = "Архивируются только сообщения, полученные во время работы bygram. iOS может приостанавливать приложение в фоне.";
"BygramMediaTitle" = "Архив медиа";
"BygramMediaArchive" = "Отдельно сохранять загруженные медиа";
"BygramMediaArchiveDesc" = "Хранить загруженные медиа в локальной базе bygram";
"BygramMediaLimit" = "Лимит архива медиа";
"BygramStorageTitle" = "Локальное хранилище";
"BygramStoredMessages" = "Сохранено сообщений: {count}";
"BygramStorageStats" = "Удалённых: {deleted} · Медиа: {media} МБ";
"BygramClearArchive" = "Очистить базу bygram";
"BygramClearArchiveDesc" = "Удалить локальную историю сообщений и сохранённые медиа";
"BygramClearConfirm" = "Локальный архив, история изменений и медиа bygram будут безвозвратно удалены.";
"BygramArchiveCleared" = "База bygram очищена";
"BygramDeleted" = "Удалено";
"BygramEditHistoryTitle" = "История изменений";
"BygramNoEditHistory" = "Предыдущие версии этого сообщения не сохранены.";
"BygramMediaMessage" = "Медиа-сообщение";
"BygramUserId" = "ID пользователя";
"BygramUserIdCopied" = "ID пользователя скопирован";
"BygramExportChat" = "Экспортировать чат в HTML";
"BygramExportChatDesc" = "Экспортировать локально сохранённые сообщения";
"BygramExportEmpty" = "В локальном архиве нет сообщений для экспорта";
"BygramExportComplete" = "Чат экспортирован";
"BygramExportError" = "Не удалось экспортировать чат";
"BygramMessageShot" = "Снимок сообщения";
"BygramMessageShotError" = "Не удалось создать снимок сообщения";
"BygramUnknownSender" = "Неизвестный отправитель";
"BygramPrivacyTitle" = "Приватность";
"BygramGhostMode" = "Режим призрака";
"BygramGhostModeDesc" = "Смотреть истории без отправки отметки о просмотре в Telegram";
"BygramGhostModeOn" = "Режим призрака включён";
"BygramGhostModeOff" = "Режим призрака выключен";
"BygramObservedLastSeen" = "Время в сети";
"BygramObservedLastSeenDesc" = "Показывать точное время, когда собеседник был замечен онлайн, даже если Telegram пишет «был недавно». Считается локально на этом устройстве по статусу, сообщениям и набору текста";
"BygramLocalVoiceTranscribe" = "Расшифровка голосовых";
"BygramLocalVoiceTranscribeDesc" = "Расшифровывать голосовые и кружки без Premium. Сначала пробуется Telegram, иначе Whisper прямо в браузере (модель скачивается один раз, ~40 МБ)";
"BygramUnrestrictedForward" = "Пересылка любых сообщений";
"BygramUnrestrictedForwardDesc" = "Пересылать сообщения даже с запретом пересылки: bygram отправит копию без пометки «переслано»";
"BygramShortcutsTitle" = "Кнопки быстрого доступа";
"BygramShortcutsDesc" = "Плавающие кнопки над списком чатов. Лента слева, музыка справа";
"BygramMusicButton" = "Кнопка музыки";
"BygramMusicButtonDesc" = "Показывать круглую кнопку bygramMusic справа внизу";
"BygramFeedButton" = "Кнопка ленты";
"BygramFeedButtonDesc" = "Показывать круглую кнопку ленты каналов слева внизу";
"BygramFeedTitle" = "Лента";
"BygramFeedBack" = "Назад к чатам";
"BygramFeedUnread" = "{count} непрочитанных постов";
"BygramFeedEmptyHint" = "Непрочитанные посты из каналов";
"BygramFeedEmpty" = "Пока нет непрочитанных постов из каналов. Когда появятся — они будут здесь, с реакциями и комментариями";
"BygramFeedOpenChannel" = "Открыть в канале";
"BygramFeaturesTitle" = "Возможности bygram";
"BygramFeaturesFooter" = "Часть функций включается в Настройки → bygram";
"MenuBygramFeatures" = "Возможности bygram";
"BygramGhostStoryAsk" = "Спрашивать перед историей";
"BygramGhostStoryAskDesc" = "Перед открытием истории предлагать выбрать, увидит ли автор отметку о просмотре";
"BygramGhostStoryTitle" = "Как смотреть историю?";
"BygramGhostStoryDesc" = "В режиме призрака автор не увидит, что вы смотрели историю.";
"BygramGhostStoryHidden" = "Смотреть скрытно";
"BygramGhostStoryNormal" = "Смотреть обычно";
"BygramArchivedGiftTab" = "Архивные";
"BygramArchivedGiftDesc" = "Редкие архивные подарки по 50 звёзд. Доступность подтверждается Telegram перед оплатой.";
"BygramLegacyGiftTree" = "Новогодняя ёлка";
"BygramLegacyGiftHeart" = "Сердце на 14 февраля";
"BygramLegacyGiftNewYearBear" = "Новогодний мишка";
"BygramLegacyGiftValentineBear" = "Мишка на 14 февраля";
"BygramLegacyGiftMarchBear" = "Мишка на 8 марта";
"BygramLegacyGiftClownBear" = "Мишка-клоун на 1 апреля";
"BygramLegacyGiftEasterBear" = "Пасхальный мишка";
"BygramLegacyGiftMayBear" = "Мишка на 1 мая";
"BygramLegacyGiftFootballBear" = "Мишка-футболист";
"BygramLegacyGiftTacticalBear" = "Тактический мишка";
"BygramChatPasswordSet" = "Установить пароль на чат";
"BygramChatPasswordChange" = "Изменить пароль чата";
"BygramChatPasswordRemove" = "Удалить пароль";
"BygramChatPasswordUnlock" = "Защищённый чат";
"BygramChatPasswordDesc" = "Пароль защищает открытие чата на этом устройстве. Данные Telegram и локальный архив не шифруются этим паролем.";
"BygramChatPasswordUnlockDesc" = "Введите локальный пароль, чтобы открыть чат.";
"BygramChatPassword" = "Пароль";
"BygramChatPasswordConfirm" = "Повторите пароль";
"BygramChatPasswordSave" = "Сохранить пароль";
"BygramChatPasswordOpen" = "Открыть чат";
"BygramChatPasswordWrong" = "Неверный пароль";
"BygramChatPasswordShort" = "Пароль должен содержать не менее 4 символов";
"BygramChatPasswordMismatch" = "Пароли не совпадают";
"BygramChatPasswordSaved" = "Пароль чата сохранён";
"BygramChatPasswordRemoved" = "Пароль чата удалён";
"BygramBubbleTitle" = "Пузырь сообщения";
"BygramBubbleDesc" = "Оформление применяется к вашим исходящим сообщениям только на этом устройстве.";
"BygramBubbleCustomColor" = "Свой цвет пузыря";
"BygramChatWallpaper" = "Обои чата из галереи";
"BygramChatWallpaperRemove" = "Убрать обои чата";
"RichEditorEquation" = "Формула";
"RichEditorEquationPrompt" = "Введите формулу";
"RichEditorEquationToBlock" = "Сделать блочной формулой";
"RichEditorEquationToInline" = "Сделать строчной формулой";
"BygramVideoMusicAdd" = "Наложить музыку";
"BygramVideoMusicTitle" = "Музыка для видео";
"BygramVideoMusicHint" = "Звук видео будет заменён выбранным отрывком. Отрывок длиннее видео обрежется.";
"BygramVideoMusicFrom" = "Начало отрывка";
"BygramVideoMusicTo" = "Конец отрывка";
"BygramVideoMusicPreview" = "Прослушать";
"BygramVideoMusicStop" = "Остановить";
"BygramVideoMusicApply" = "Наложить";
"BygramVideoMusicProcessing" = "Наложение музыки…";
"BygramVideoMusicFailed" = "Не удалось наложить музыку";
"BygramVideoMusicUnsupported" = "Не удалось прочитать этот файл. Попробуйте другой формат, например mp3 или m4a.";
"BygramVideoMusicLoading" = "Читаем файл…";
`;export{e as default};
//# sourceMappingURL=fallback-_xj1TNrB.js.map