...
`;function ye(e,t,n){let r=e.createShader(t);if(r){if(e.shaderSource(r,n),e.compileShader(r),!e.getShaderParameter(r,e.COMPILE_STATUS)){e.deleteShader(r);return}return r}}function be(e,t,n){let r=e.createProgram();if(r){if(e.attachShader(r,t),e.attachShader(r,n),e.linkProgram(r),!e.getProgramParameter(r,e.LINK_STATUS)){e.deleteProgram(r);return}return r}}var xe=class{seed;constructor(e){this.seed=e}next(){return this.seed=(this.seed*9301+49297)%233280,this.seed/233280}nextBetween(e,t){return e+(t-e)*this.next()}},V;function Se(){if(!V){V=new Float32Array(72);for(let e=0;e<18;e++){let t=220*Math.PI/180*e,n=Math.cos(t),r=Math.sin(t);V[e*4]=n,V[e*4+1]=r,V[e*4+2]=-r,V[e*4+3]=n}}return V}function Ce(e,t){if(e instanceof S)return e;let[n,r]=e,[i,a,o]=n.coords,[s,c,l]=r.coords;return new S(`srgb`,[t.nextBetween(i||0,s||0),t.nextBetween(a||0,c||0),t.nextBetween(o||0,l||0)])}var we={sparkles:`JxY8hVTW`},Te={centerShift:[0,-36]},Ee=8,De=s(({color:e=`purple`,centerShift:t=Te.centerShift,isDisabled:n,className:r,onRequestAnimation:o})=>{let s=a(),l=a(0);return c(()=>{if(!n)return he(s.current,{color:ue[`${e}Gradient`],centerShift:t})},[t,e,n]),i(()=>{o&&o(()=>{if(n)return;let r=Date.now();r-l.current<Ee||(l.current=r,he(s.current,{color:ue[`${e}Gradient`],centerShift:t,...de}))})},[t,e,n,o]),m(`canvas`,{ref:s,className:p(we.sparkles,r)})}),Oe={root:`CHDf16MJ`,diamond:`UM7C8oRj`},ke=``+new URL(`diamond-57JalFxA.png`,import.meta.url).href,Ae=5,je=1,Me=300,Ne=1500,H,U=!0,Pe={isCancelled:!1};function Fe({className:e,onMouseMove:n}){let[i,a]=r(je),o=y(()=>{H&&=(clearTimeout(H),void 0),H=window.setTimeout(()=>{let e=Date.now();U=!0,P(()=>{if(!U)return!1;let t=Math.min((Date.now()-e)/Ne,1),n=4*(1-Le(t));return a(n),U=t<1&&n>1,U},t,Pe)},Me),U=!1,a(Ae),n()});return m(`div`,{className:p(Oe.root,e),children:m(`div`,{className:Oe.diamond,onMouseMove:o,children:m(C,{speed:i,size:130,tgsUrl:N.Diamond,previewUrl:ke,nonInteractive:!0,noLoop:!1})})})}var Ie=s(Fe);function Le(e){return 1-(1-e)**2}var W={root:`QcfrGLdX`,star:`nDPg-zs5`,star_purple:`-f2S1Tk6`,starPurple:`-f2S1Tk6`},Re=50;function ze({className:e,color:n,centerShift:r,onMouseMove:i}){let o=a(),s=y(e=>{let n=e.currentTarget.getBoundingClientRect(),a=n.left+n.width/2+r[0],s=n.top+n.height/2+r[1],c=e.clientX-a,l=e.clientY-s,u=Math.max(-1,Math.min(1,c/Re)),d=Math.max(-1,Math.min(1,l/Re)),f=u*40,p=-d*40;t(()=>{o.current.style.transform=`scale(1.1) rotateX(${p}deg) rotateY(${f}deg)`}),i()}),c=y(()=>{t(()=>{o.current.style.transform=``})});return m(`div`,{className:p(W.root,e),onMouseMove:s,onMouseLeave:c,children:m(`div`,{ref:o,className:p(W.star,W[`star_${n}`]),role:`img`,"aria-label":`Telegram Stars`})})}var Be=s(ze),G={root:`cK6KQXnQ`,"ai-egg":`ZP86O9Hy`,aiEgg:`ZP86O9Hy`,title:`xRm-Im3m`,description:`IQdQ9MU9`,particles:`_8ooQ3s8b`,stickerWrapper:`hHs2sTV-`,cocoon:`Rlhm9gZk`},Ve=``+new URL(`cocoon-DzgJltGQ.webp`,import.meta.url).href,K=8*A,He={centerShift:[0,-36]};function Ue({model:e,sticker:t,color:n,title:r,description:i,isDisabled:o,className:s,modelClassName:c}){let l=a(),u=a(),f=y(()=>{u.current?.()}),h=y(e=>{u.current=e});return d(`div`,{className:p(G.root,G[e],s),children:[m(De,{color:n,centerShift:He.centerShift,isDisabled:o,className:G.particles,onRequestAnimation:h}),e===`swaying-star`?m(Be,{className:c,color:n,centerShift:He.centerShift,onMouseMove:f}):e===`ai-egg`?m(`img`,{src:Ve,alt:``,role:`presentation`,"aria-hidden":`true`,className:p(G.cocoon,c),draggable:!1,onMouseMove:f}):e===`speeding-diamond`?m(Ie,{className:c,onMouseMove:f}):e===`sticker`&&t&&m(`div`,{ref:l,className:p(G.stickerWrapper,c),style:`width: ${K}px; height: ${K}px`,onMouseMove:f,children:m(ee,{containerRef:l,sticker:t,size:K,shouldPreloadPreview:!0,shouldLoop:!0})}),m(`h2`,{className:G.title,children:r}),m(`div`,{className:G.description,children:i})]})}var We=s(Ue),q={root:`_7NV36hp3`,wrapper:`_32sWnI-2`,down:`DkDmNeYG`,frame:`M0hUT4cv`,video:`eWi57MWV`,placeholder:`A38HRiXg`},Ge=``+new URL(`DeviceFrame-Dqm_t18H.svg`,import.meta.url).href,Ke=s(({videoId:e,videoThumbnail:t,isActive:n,isReverseAnimation:r,isDown:i,index:a,className:o,wrapperClassName:s})=>{let c=T(e?`document${e}`:void 0),l=re(t?.dataUri),u=w(c);return m(`div`,{className:p(q.root,o),children:d(`div`,{className:p(q.wrapper,r&&q.reverse,i&&q.down,s),id:a===void 0?void 0:`premium_feature_preview_video_${a}`,children:[m(`img`,{src:Ge,alt:``,className:q.frame,draggable:!1}),!e&&m(`div`,{className:q.placeholder}),t&&m(`canvas`,{ref:l,className:q.video}),e&&m(E,{canPlay:!!n,className:p(q.video,u),src:c,disablePictureInPicture:!0,playsInline:!0,muted:!0,loop:!0})]})})}),J={options:`Upert7zo`,option:`_2X6-9ciP`,active:`zpGahRpW`,wideOption:`dI8-J8yI`,optionTop:`wgA5YkCl`,stackedStars:`TZ71sXrE`,stackedStar:`_6CGkOJue`,optionBottom:`GRPtw1Lm`,moreOptions:`cY6CHTaj`,iconDown:`qdRs-uv4`},qe=6,Je=s(({isActive:e,className:t,options:n,selectedStarOption:r,selectedStarCount:a,starsNeeded:o,onClick:s})=>{let c=O(),u=M(),[f,y,x]=te();i(()=>{e||x()},[e]);let[S,C]=l(()=>{if(!n)return[void 0,!1];let e=n.reduce((e,t)=>e.stars>t.stars?e:t),t=o&&e.stars<o,r=[],i=0,a=!1;return n.forEach((e,s)=>{if(e.isExtended||i++,!(o&&!t&&e.stars<o)){if(!f&&e.isExtended){a=!0;return}r.push({option:e,starsCount:Math.min(i,qe),isWide:s===n.length-1})}}),[r,a]},[f,n,o]);return d(`div`,{className:p(J.options,t),children:[S?.map(({option:e,starsCount:t,isWide:n})=>{let i=S?.length%2==0,o=e===r,l;return e&&`winners`in e&&(l=(e.winners.find(e=>e.users===a)||e.winners.reduce((e,t)=>t.users>e.users?t:e,e.winners[0]))?.perUserStars),d(`div`,{className:p(J.option,!i&&n&&J.wideOption,o&&J.active),onClick:()=>s?.(e),children:[d(`div`,{className:J.optionTop,children:[`+`,_(e.stars),m(`div`,{className:J.stackedStars,dir:u.isRtl?`ltr`:`rtl`,children:Array.from({length:t}).map(()=>m(g,{className:J.stackedStar,type:`gold`,size:`big`}))})]}),m(`div`,{className:J.optionBottom,children:v(u,e.amount,e.currency)}),(o||r&&`winners`in r)&&!!l&&m(`div`,{className:J.optionBottom,children:m(`div`,{className:J.perUserStars,children:h(c(`BoostGift.Stars.PerUser`,_(l)))})})]},e.stars)}),!f&&C&&d(j,{className:J.moreOptions,isText:!0,noForcedUpperCase:!0,onClick:y,children:[c(`Stars.Purchase.ShowMore`),m(b,{className:J.iconDown,name:`down`})]})]})}),Y={content:`j63Xdo6p`,fixedHeight:`E-xx83T0`,withSearch:`sT1YPCzK`,header:`RwB3BKcO`,buttonWrapper:`Z-xvJZEk`},Ye=`.${ae.pickerList}`,Xe=s(({confirmButtonText:e,isConfirmDisabled:t,shouldAdaptToSearch:n,withFixedHeight:r,onConfirm:i,withPremiumGradient:o,itemsContainerSelector:s=Ye,...c})=>{let l=O(),u=!!(e||i),f=a();return L({containerRef:f,selector:`.modal-content ${s}`,isBottomNotch:u,shouldHideTopNotch:!0},[c.isOpen]),d(F,{...c,dialogRef:f,isSlim:!0,className:p(n&&Y.withSearch,r&&Y.fixedHeight,c.className),contentClassName:p(Y.content,c.contentClassName),headerClassName:p(Y.header,c.headerClassName),isCondensedHeader:!0,children:[c.children,u&&m(`div`,{className:Y.buttonWrapper,children:m(j,{withPremiumGradient:o,onClick:i||c.onClose,color:`primary`,disabled:t,children:e||l(`Confirm`)})})]})}),X={table:`RMEi5Sgb`,cell:`AEl8NMjg`,title:`IypKoG1m`,value:`ZO-KCUSl`,fullWidth:`_1WIqSuNB`,chatItem:`J6it2-iy`},Ze=s(({tableData:e,className:t,onChatClick:n})=>{let{openChat:r}=f(),i=y(e=>{n?n(e):r({id:e})});if(e?.length)return m(`div`,{className:p(X.table,t),children:e.map(([e,t])=>d(u,{children:[!!e&&m(`div`,{className:p(X.cell,X.title),children:e}),m(`div`,{className:p(X.cell,X.value,!e&&X.fullWidth),children:typeof t==`object`&&`chatId`in t?m(ie,{peerId:t.chatId,className:X.chatItem,forceShowSelf:!0,withEmojiStatus:t.withEmojiStatus,clickArg:t.chatId,onClick:i}):t})]}))})}),Z={content:`rIjOLQyf`,noFooter:`ssGgYoZw`,avatar:`IdvEatvm`},Qe=s(({isOpen:e,title:t,tableData:n,headerAvatarPeer:r,header:i,modalHeader:a,footer:o,buttonText:s,className:c,contentClassName:l,tableClassName:u,hasBackdrop:h,closeButtonColor:g,moreMenuItems:_,headerRightToolBar:v,onClose:b,onButtonClick:x,withBalanceBar:S,isLowStackPriority:C,currencyInBalanceBar:w})=>{let{openChat:T}=f(),E=y(e=>{T({id:e}),b()});return d(F,{isOpen:e,hasCloseButton:!!t,hasAbsoluteCloseButton:!t,absoluteCloseButtonColor:g||(h?`translucent-white`:void 0),isSlim:!0,header:a,title:t,className:c,contentClassName:p(Z.content,l),moreMenuItems:_,headerRightToolBar:v,onClose:b,withBalanceBar:S,currencyInBalanceBar:w,isLowStackPriority:C,children:[r&&m(D,{peer:r,size:`jumbo`,className:Z.avatar}),i,m(Ze,{tableData:n,className:u,onChatClick:E}),o,s&&m(j,{className:o?void 0:Z.noFooter,onClick:x||b,children:s})]})}),Q={root:`FEEwg5rl`,secondary:`_51eeI1vd`,topIcon:`_0fVPMdEi`,premiumGradient:`oEaPoig5`,content:`_7xJ2IMc7`,listItems:`_4Smlf3-h`,listItemTitle:`lPVHA-w3`,separator:`V6iMhrLh`},$e=s(({className:e,isOpen:t,listItemData:n,headerIconName:r,headerIconPremiumGradient:i,header:a,footer:o,buttonText:s,hasBackdrop:c,absoluteCloseButtonColor:l,withSeparator:u,contentClassName:f,onClose:h,onButtonClick:g})=>d(F,{isOpen:t,className:p(Q.root,e),contentClassName:p(Q.content,f),hasAbsoluteCloseButton:!0,absoluteCloseButtonColor:l||(c?`translucent-white`:void 0),onClose:h,children:[r&&m(`div`,{className:p(Q.topIcon,i&&Q.premiumGradient),children:m(b,{name:r})}),a,m(`div`,{className:Q.listItems,children:n?.map(([e,t,n])=>d(I,{isStatic:!0,multiline:!0,icon:e,className:Q.listItem,children:[m(`span`,{className:p(`title`,Q.listItemTitle),children:t}),m(`span`,{className:`subtitle`,children:n})]}))}),u&&m(oe,{className:Q.separator}),o,!!s&&m(j,{onClick:g||h,children:s})]})),$={root:`JaXKxj2K`,arrow:`_-7ow-ETi`},et=4*A,tt=s(({fromPeer:e,toPeer:t,avatarSize:n=et})=>d(`div`,{className:$.root,children:[m(D,{peer:e,size:n}),m(b,{name:`next`,className:$.arrow}),m(D,{peer:t,size:n})]}));export{Xe as a,We as c,se as d,Ze as i,De as l,$e as n,Je as o,Qe as r,Ke as s,tt as t,ce as u};
//# sourceMappingURL=TransferBetweenPeers-DN5H7EsT.js.map