...
"BygramSettingsDesc" = "Local archive and message protection";
"BygramArchiveTitle" = "Message archive";
"BygramLocalArchive" = "Local message archive";
"BygramLocalArchiveDesc" = "Keep received message text and metadata in IndexedDB";
"BygramAntiDelete" = "Anti-delete";
"BygramAntiDeleteDesc" = "Keep messages that Telegram later reports as deleted";
"BygramEditHistory" = "Edit history";
"BygramEditHistoryDesc" = "Keep previous versions of edited messages";
"BygramIosNotice" = "Only messages received while bygram was running can be archived. iOS may suspend the app in the background.";
"BygramMediaTitle" = "Media archive";
"BygramMediaArchive" = "Save downloaded media separately";
"BygramMediaArchiveDesc" = "Keep downloaded media in the local bygram database";
"BygramMediaLimit" = "Media archive limit";
"BygramStorageTitle" = "Local storage";
"BygramStoredMessages" = "Stored messages: {count}";
"BygramStorageStats" = "Deleted: {deleted} · Media: {media} MB";
"BygramClearArchive" = "Clear bygram database";
"BygramClearArchiveDesc" = "Remove local message history and archived media";
"BygramClearConfirm" = "All locally archived messages, edit history, and bygram media will be permanently removed.";
"BygramArchiveCleared" = "bygram database cleared";
"BygramDeleted" = "Deleted";
"BygramEditHistoryTitle" = "Edit history";
"BygramNoEditHistory" = "No previous versions are stored for this message.";
"BygramMediaMessage" = "Media message";
"BygramUserId" = "User ID";
"BygramUserIdCopied" = "User ID copied";
"BygramExportChat" = "Export chat to HTML";
"BygramExportChatDesc" = "Export locally archived messages";
"BygramExportEmpty" = "No locally archived messages to export";
"BygramExportComplete" = "Chat exported";
"BygramExportError" = "Could not export chat";
"BygramMessageShot" = "Message shot";
"BygramMessageShotError" = "Could not create message shot";
"BygramUnknownSender" = "Unknown sender";
"Month2" = "February";
"Month3" = "March";
"Month4" = "April";
"Month5" = "May";
...
`;export{e as default};
//# sourceMappingURL=fallback-L1vvbUrK.js.map